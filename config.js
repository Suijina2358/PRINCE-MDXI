...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "prince_md-eBsCCB7R#nMny4VcPttHZvcQID0CxVno4ULsfyIX2ayD4qSE3vWw",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*COEUR EN PANNE SEEN YOUR STATUS *",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝐏𝐑𝐈𝐍𝐂𝐄 𝐌𝐃𝐗",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "COEUR EN PANNE
    ",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "237697892154",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "COEUR EN PANNE 🕷",
// add bot owner name
